...
const proCommands = [['pro', 'Open the pro platform HUD'], ['tools', 'Browse the 70+ tool registry'], ['apis', 'Browse opt-in API modules'], ['plugins', 'Inspect the plugin registry'], ['theme', 'Select a HUD theme'], ['ownercheck', 'Diagnose owner access'], ['grantpro', 'Owner: grant Pro access'], ['revokepro', 'Owner: revoke Pro access']];
